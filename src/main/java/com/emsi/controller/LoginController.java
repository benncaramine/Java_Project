...
public class LoginController {
    ...
    public void login() {
        ...
        if (stadiumService.validateUser(username, password)) {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/emsi/View/StadiumList.fxml"));
                ...
                stage.setTitle("Stadium Application");
                stage.show();
